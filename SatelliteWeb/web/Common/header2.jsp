    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav" style="font-family: arial;">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active" style="padding:10px 10px 0px 10px;"><a href="document.jsp" class="nav-link" ><p style="color:yellow;">Document</p></a></li>
          ...
          <li class="nav-item" style="padding:10px 10px 0px 10px;"><a href="about.jsp" class="nav-link">About</a></li>
