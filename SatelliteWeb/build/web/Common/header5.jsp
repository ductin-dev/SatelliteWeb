    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav" style="font-family: arial;">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item" style="padding:10px 10px 0px 10px;"><a href="index.jsp" class="nav-link">Home</a></li>
          <li class="nav-item" style="padding:10px 10px 0px 10px;"><a href="document.jsp" class="nav-link" >Document</a></li>
          <li class="nav-item" style="padding:10px 10px 0px 10px;"><a href="projects.jsp" class="nav-link">Projects</a></li>
          <li class="nav-item" style="padding:10px 10px 0px 10px;"><a href="blog.jsp" class="nav-link">Blog</a></li>
          <li class="nav-item active" style="padding:10px 10px 0px 10px;"><a href="about.jsp" class="nav-link"><p style="color:yellow;">About</p></a></li>
          <li class="nav-item" style="padding:10px 10px 0px 10px;"><a href="myteam.jsp" class="nav-link">My Team</a></li>
        </ul>
      </div>
    </div>
    </nav>
